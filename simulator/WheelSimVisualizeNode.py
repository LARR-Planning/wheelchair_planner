...
class WCSimBase:
    def __init__(self, settings_yaml):
        ...
        self.viz_robot_sub = rospy.Subscriber("nav_to_planner", Float64MultiArray, self.viz_robot_callback ,queue_size=1)
    ...
    def viz_robot_callback(self, data):
        error: Float64MultiArray = data
        _, _, t_cur, y_err, theta_err, x_dot_r, y_dot_r, theta_dot_r, isStop = error.data
        self.wheel_sim._visualize_with_rostopic(y_err, theta_err)
